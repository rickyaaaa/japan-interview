/**
 * app.js — Traditional asset (no Vite/NPM bundler)
 *
 * AlpineJS is loaded via CDN <script> tag in the blade template
 * with the "defer" attribute, so Alpine is available globally.
 * Axios is NOT used — the code already uses native fetch().
 */
